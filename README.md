...
| 프로젝트 | 기간 | 설명 | 기술 | 성과 / 링크 |
|:----------:|:------|:------|:------|:------|
| **FTL Simulator (GameGC)** | 2025.10 – Ongoing | 다양한 GC 정책(Greedy, Cost-Benefit, CAT)을 C로 구현하고, Pipeline 기반 **GameGC** 방식의 성능 비교 실험 수행 | C, File I/O, Visualization | **Ongoing Research Project**<br/>GC latency의 **스파이크 vs 점진적 회수 패턴** 분석 중<br/>[🔗 GitHub](https://github.com/day-e0n/ssp_team_project.git) |
